...
export declare enum EInstallationState {
...
export declare enum EInstallType {
    GIT_CLONE = "git-clone",
    COPY = "copy",
    CNR = "cnr",
    UNZIP = "unzip"
}
export declare enum EExtensionUpdateCheckResult {
    NO_UPDATE = 0,
    UPDATE_AVAILABLE = 1,
    FAILED = 2
}
export declare enum EUpdateResult {
    UNCHANGED = 0,
    SUCCESS = 1,
    FAILED = 2
}
