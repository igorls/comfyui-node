...
export declare class CallWrapper<I extends string, O extends string, T extends NodeData> {
    ...
    private jobResolveFn?;
    private jobDoneResolved;
    private pendingCompletion;
    private cancellationRequested;
    private promptLoadTrigger;
    private disconnectRecoveryActive;
    private disconnectFailureTimer;
    private onReconnectHandlerOffFn;
    private onReconnectFailedHandlerOffFn;
