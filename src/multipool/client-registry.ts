...
export class ClientRegistry {
  ...
  getOptimalClient(workflow: Workflow, priorityOverrides?: Map<string, number>) {
  ...
  async getOptimalIdleClient(workflow: Workflow, priorityOverrides?: Map<string, number>) {
